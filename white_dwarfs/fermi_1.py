...
r_ur, p_ur, m_ur, status_ur = solve_tov_eos(p_central_geo, rho_degenerate_fermions_ur_geo)
...
r_nr, p_nr, m_nr, status_nr = solve_tov_eos(p_central_geo, rho_degenerate_fermions_nr_geo)
