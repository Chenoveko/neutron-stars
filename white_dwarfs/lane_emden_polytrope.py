# https://zingale.github.io/comp_astro_tutorial/stars/lane-emden.html
...
# Table of the important parameters
n_list = [0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5] # n < 5

for i, nindex in enumerate(n_list):
    p = Polytrope(nindex)
    params = p.get_params()
    if i == 0:
