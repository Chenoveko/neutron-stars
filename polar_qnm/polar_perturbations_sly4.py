...
# Concatenate
p_total_sly4 = concatenate((p_down_sorted, p_central_array_geo_up))
f_total_sly4 = concatenate((f_down_sorted, array(f_sly4_up)))
tau_total_sly4 = concatenate((tau_down_sorted, array(tau_sly4_up)))
# Make xlabel
log_p_total_sly4 = log10(pressure_geo_to_cgs(p_total_sly4))
# Save results
savez("sly4_results.npz",log_p=log_p_total_sly4,f=f_total_sly4,tau=tau_total_sly4)

# ==========Plot 1: Frequency vs Central Pressure==========#
fig_f, ax_f = plt.subplots(figsize=(7.5, 4.5))
ax_f.plot(log_p_total_sly4, array(f_total_sly4), color='red', linewidth=1.5, label="SLy4")
...
ax_tau.plot(log_p_total_sly4, array(tau_total_sly4), color='red', linewidth=1.5, label="SLy4")
